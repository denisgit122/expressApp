...
import css from '../../componentsAuth/Car/Car.module.css'
import {carAction} from "../../../redux";
import {ButtonSearch, Loading, Price, SelectCar, Year} from "../../componentsAuth";
import {SelectCity} from "../../componentsAuth/Search";
import {CarMan} from "../CarMan/CarMan";
...

            {
                load ? <div className={css.loading}><Loading/></div>
                    ...
                    <div className={css.boxWithCar}>
                        {car ?
                            car.map(car => <CarMan key={car._id} car={car}/>)
                            :cars.map(car => <CarMan key={car._id} car={car}/>)}
                    </div>
            }
